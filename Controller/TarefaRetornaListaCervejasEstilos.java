...
public class TarefaRetornaListaCervejasEstilos extends AsyncTask<String, Integer, ArrayList<String>> {
    ...
    public TarefaRetornaListaCervejasEstilos(ListaCervejasActivity context) {
    ...
    protected ArrayList<String> doInBackground(String... strings) {
        ...
        try {
            URL url = new URL(caminhoServlets.getCaminho() + "ServletConsultaCerveja");
