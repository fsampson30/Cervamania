...
public class TarefaRetornaListaComentariosCervejaSelecionada extends AsyncTask<String, Void, ArrayList<String>> {
    ...
    public TarefaRetornaListaComentariosCervejaSelecionada(ListaClassificacaoCervejaSelecionadaActivity context) {
    ...
    protected ArrayList<String> doInBackground(String... strings) {
        ...
        try {
            URL url = new URL(caminhoServlets.getCaminho() + "/ServletConsultaComentariosRanking");
    ...
    protected void onPostExecute(ArrayList<String> listaNomesCervejas) {
        ...
        context.retornoTarefaListaComentarios(listaNomesCervejas);
    }
}
