...
public class TarefaRetornaListaCervejasPaises extends AsyncTask<String, Void, ArrayList<String>> {
    ...
    public TarefaRetornaListaCervejasPaises(ListaCervejasActivity context) {
    ...
    protected ArrayList<String> doInBackground(String... strings) {
        ...
        try {
            URL url = new URL(caminhoServlets.getCaminho() + "/ServletConsultaCervejaPais");
